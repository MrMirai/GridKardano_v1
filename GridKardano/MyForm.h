...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Segoe Print", 20.25F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
			...
			// trackBar1
			// 
			this->trackBar1->Location = System::Drawing::Point(162, 101);
			...
			this->panel1->Location = System::Drawing::Point(13, 140);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(550, 310);
			...
			this->pictureBox1->Size = System::Drawing::Size(547, 310);
...
#pragma endregion
	...
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		Pen^ p = gcnew Pen(Color::Cyan);
		int r =0;
			for (int i = 0; i < trackBar1->Value + 1; i++)
			{
				gr->DrawLine(p, 0+r, 0, 0+r, trackBar1->Value*20);
				gr->DrawLine(p, 0, 0+r, trackBar1->Value*20, 0+r);
				r += 20;
			}
			...
			//array<char^, 2>^ shifr = gcnew array<char^, 2>(N, N);
			int** shifr = new int* [N];
			for (int i = 0; i < N; i++)
				shifr[i] = new int[N];
